...
\begin{itemize}
    \item Geometric/Holomorphic quantization of kahler manifolds \cite{Schlichenmaier_2010}
%    \begin{itemize}
...
$$
    \item Rozansky-Witten Theory as 3-dimensional topological sigma-model with a hyperkahler manifold as target space.
    \end{itemize}
\end{itemize}
